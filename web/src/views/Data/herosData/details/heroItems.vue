  ...
  <div style="width:740px;padding:2px 15px;overflow:hidden;border-top:0px;position:relative">
    ...
    ></data-format>
       <data-list :datas="itemList">
            <data-coloum thing="items" label="物品" prop="name" width="20%"></data-coloum>
            ...
            <data-coloum thing="items" label="使用次数" prop="playeds" width="30%"></data-coloum>
            <data-coloum thing="items" label="胜率" prop="winRates" width="30%"></data-coloum>
       </data-list>
   </div>
    ...
    methods:{
        ...
        fetchDatas(skill,ladder){
           ...
           headers:{
             ...
             this.itemList = res.data.filter(item=>{
               return item
           })
