    ...
    <div class="hero_container text-center">
      <header>
        <ul class="d-flex ai-center">
          ...
          <li>
            <router-link :to="`/heros/details/${$route.params.id}/heroitems`"
              >物品</router-link
            >
          </li>
          <li>
            <router-link :to="`/heros/details/${$route.params.id}/teammates`"
              >队友英雄分析</router-link
            >
          </li>
          <li>
            <router-link :to="`/heros/details/${$route.params.id}/opponents`"
              >对手英雄分析</router-link
            >
          </li>
          <li>
            <router-link :to="`/heros/details/${$route.params.id}/trends`"
              >Trends</router-link
            >
          </li>
        </ul>
