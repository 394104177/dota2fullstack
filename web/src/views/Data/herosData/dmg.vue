<template>
    ...
    ></data-format>
        <data-list :datas="heroDatas" :style="'color:white'">
            ...
            <data-coloum label="伤害/分钟"   :prop='`dmg.${skill}.${ladder}.d`' width="300"/>
            <data-coloum label="治疗/分钟"  :prop='`dmg.${skill}.${ladder}.h`' width="300"/>
            <data-coloum label="建筑伤害/分钟" :prop='`dmg.${skill}.${ladder}.bd`' width="300"/>
